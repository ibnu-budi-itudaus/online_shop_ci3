<div class="container-fluid">
	...
	<table class="table table-bordered">
		...
		<tr>
			<td><?php echo $no; ?></td>
			<td><?php echo $brg->nama_toko ?></td>
			<td><?php echo $brg->alamat ?></td>
			<td>
          <?php echo anchor('admin/data_barang/detail/' .$brg->id_toko, '<div class="btn btn-sm btn-success"><i class="fas fa-search-plus"></i></div>') ?>
			</td>
			<td>
				<?php echo anchor('admin/data_barang/edit/' .$brg->id_toko, '<div class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></div>') ?>
			</td>
			<td>
				<?php echo anchor('admin/data_barang/hapus/' .$brg->id_toko, '<div class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></div>') ?>
			</td>
		</tr>
			<?php $no++; ?>
		<?php endforeach; ?>
